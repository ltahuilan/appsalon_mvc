...
class Router
{
    ...
    public function render($view, $datos = []) {
        ...
        foreach ($datos as $key => $value) {
            /**Doble signo de dolar significa: variable variable, nuestra variable sigue siendo la original,
        ...
        //$contenido se llama desde layout.php 
